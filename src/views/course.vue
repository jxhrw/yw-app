    ...
    methods: {
      downs() {
        ...
        if (device == "androidApp") {
          window.Android.loadImg('https://youwatch.oss-cn-beijing.aliyuncs.com/app/activity/course/course.JPG');
        } else if (device == "iosApp") {
          window.webkit.messageHandlers.loadImg.postMessage({
            'url': 'https://youwatch.oss-cn-beijing.aliyuncs.com/app/activity/course/course.JPG'
          });
        }
      }
    },
