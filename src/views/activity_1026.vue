  ...
  export default {
    ...
    methods: {
      ...
      handleScroll() {
        ...
        sessionStorage.setItem("act1026", scrollTop);
      },
      //分享网页
      shareUrl() {
    ...
    activated() {
      ...
      if (!this.$route.meta.isBack) {
        ...
        this.$refs.bodyhtml.scrollTop = sessionStorage.getItem("act1026");
      }
    },
  };
...
<style scoped>
  ...
  .header {
    width: 100%;
    height: 7.9rem;
    background: url('https://youwatch.oss-cn-beijing.aliyuncs.com/app/activity/181026/header.png') no-repeat top center/100%;
  }
