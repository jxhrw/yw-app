<template>
  <div id="activity_1119">
    ...
    <div class="content" ref="bodyhtml">
      ...
      <img src="https://youwatch.oss-cn-beijing.aliyuncs.com/app/activity/181119cf/act1119_01.png" class="header" alt="">
      <img src="https://youwatch.oss-cn-beijing.aliyuncs.com/app/activity/181119cf/act1119_02.png" class="header" alt="">
      <img src="https://youwatch.oss-cn-beijing.aliyuncs.com/app/activity/181119cf/act1119_03.png" class="header" alt="">
      <img src="https://youwatch.oss-cn-beijing.aliyuncs.com/app/activity/181119cf/act1119_04.png" class="header" alt="">
      <img src="https://youwatch.oss-cn-beijing.aliyuncs.com/app/activity/181119cf/act1119_05.png" class="header" alt="">
      <img src="https://youwatch.oss-cn-beijing.aliyuncs.com/app/activity/181119cf/act1119_06.png" class="header" alt="">
      <!-- <img src="https://youwatch.oss-cn-beijing.aliyuncs.com/app/activity/181119cf/act1119_07.png" class="header" alt=""> -->
      <img src="https://youwatch.oss-cn-beijing.aliyuncs.com/app/activity/181119cf/title1.png" class="header" style="width:76.133%;margin-top:0.8rem;margin-bottom:0.4rem;"
        alt="">
      <ul class="actList">
        <!-- <li >@click="toDetail(1)" -->
  ...
  export default {
    ...
    methods: {
      ...
      handleScroll() {
        ...
        sessionStorage.setItem("act1119f", scrollTop);
      },
      //分享网页
      shareUrl() {
        let device = this.whichDevice();
        let url = window.location.href;
        let name = '”有盟会”集结号:沈记珠宝钟表行';
        let desc = '广交好友，诚信经营';
    ...
    activated() {
      ...
      if (!this.$route.meta.isBack) {
        ...
        this.$refs.bodyhtml.scrollTop = sessionStorage.getItem("act1119f");
      }
    },
  };
