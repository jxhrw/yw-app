  ...
  export default {
    ...
    methods: {
      ...
      handleScroll() {
        ...
        sessionStorage.setItem("act1110", scrollTop);
      },
      //分享网页
      shareUrl() {
    ...
    activated() {
      ...
      if (!this.$route.meta.isBack) {
        ...
        this.$refs.bodyhtml.scrollTop = sessionStorage.getItem("act1110");
      }
    },
  };
...
<style scoped>
  ...
  .header {
    width: 100%;
    height: 7.9rem;
    background: url('https://youwatch.oss-cn-beijing.aliyuncs.com/app/activity/181110/header.png') no-repeat top center/100%;
  }
