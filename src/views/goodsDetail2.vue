<template>
  <div id="goodsDetail">
    ...
    <ywBar v-if="isApp" type="shareWhite" :goodsPrice="parseInt(proPrice)" :agentId="agentId" :goodsId="goodsId" :goodsName="proName" :goodsImg="slides[0]" :shareBtnShow="showBuy"></ywBar>
    <footer v-if="power>=0">
